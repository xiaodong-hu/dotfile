...
function addressparser(str) {
    ...
    tokens.forEach(function(token) {
        if (token.type === 'operator' && (token.value === ';')) { // removed token.value === ',' ||  because of this https://bitbucket.org/jasonsav/checker-plus-for-gmail/issues/108/issue-with-commas-in-from-name
            if (address.length) {
